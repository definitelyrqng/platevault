    ...
    <main className="min-h-[calc(100vh-96px)] grid place-items-center px-6">
      <div className="w-full max-w-sm">
        ...
        <div className="text-center mb-7">
          ...
          <h1 className="text-3xl font-black text-zinc-50">Welcome back</h1>
          <p className="text-sm text-zinc-500 mt-1.5">Sign in to continue spotting</p>
        </div>
        ...
        >
          ...
          <button
            type="submit"
            disabled={loading}
            className="group relative mt-1 w-full overflow-hidden rounded-xl bg-indigo-600 py-3 text-sm font-bold text-white hover:bg-indigo-500 active:scale-[0.98] disabled:opacity-60 disabled:cursor-not-allowed transition-all shadow-lg shadow-indigo-950/50"
          >
