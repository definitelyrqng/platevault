  ...
  return (
    <main className="mx-auto max-w-3xl px-6 py-10">
      ...
      <div className="mb-8">
        ...
        <p className="mt-2 text-sm text-zinc-400 ml-4">
      ...
      <div className="grid gap-3">
        {[
          ...
          >
            <span className="text-3xl shrink-0 group-hover:scale-110 transition-transform duration-200">{c.flag}</span>
            <div className="min-w-0 flex-1">
              <div className="font-semibold text-zinc-200 group-hover:text-indigo-200 transition-colors">{c.name}</div>
